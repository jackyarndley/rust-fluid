...
pub fn empty(_: f64, _: f64, _: &dyn Fn(f64, f64) -> f64, _: f64) -> f64 {
    0.0
}

pub fn euler(t: f64, y: f64, f: &dyn Fn(f64, f64) -> f64, dt: f64) -> f64 {
    y + f(t, y) * dt
}

pub fn bogacki_shampine(t: f64, y: f64, f: &dyn Fn(f64, f64) -> f64, dt: f64) -> f64 {
    let k1 = f(t, y);
